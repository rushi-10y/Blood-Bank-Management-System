...
@app.route('/organdonor.html', methods=['GET'])
def organdonar():
    return render_template('organdonor.html')
@app.route('/blooddonor.html', methods=['GET', 'POST'])
def bloodonar():
    return render_template('blooddonor.html')
@app.route('/bloodbank.html', methods=['GET', 'POST'])
def bloodbank():
    return render_template('bloodbank.html')
@app.route('/organbankinfo.html', methods=['GET', 'POST'])
def organbankinfo():
